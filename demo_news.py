...
# ──────────────────────────────────────
# ⬇️ STEP 3. 이전에 표시한 기사 제외 (매일 새 기사만) (중복 방지)
# ──────────────────────────────────────
...
# ──────────────────────────────────────
# ============================================
# ⬇️ STEP 4. 불필요 기사 필터링 (스포츠/주식 등 제거)
# ============================================
# ──────────────────────────────────────
EXCLUDE_KEYWORDS = [
    # 스포츠
...
def classify_article(art):
    ...
    # 섹션 결정 우선순위: 에너지 > 수주(명확할 때) > 리스크 > 대형사 수주
    if has_energy:
        section = "에너지 사업"
