...
<head>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .logo-ci {{ display: flex; align-items: center; gap: 2px; }}
        .logo-tri {{ width: 0; height: 0; }}
        .logo-tri-yellow {{ border-left: 18px solid transparent; border-right: 18px solid transparent; border-bottom: 32px solid #d4a017; }}
        .logo-tri-green {{ border-left: 18px solid transparent; border-right: 18px solid transparent; border-bottom: 32px solid #15ad60; margin-left: -12px; }}
        .header-title {{ display: flex; flex-direction: column; }}
        .header h1 {{ font-size: 24px; font-weight: 800; color: #1a1a1a; letter-spacing: 1px; }}
        .header-sub {{ font-size: 12px; color: #888; font-weight: 400; margin-top: 2px; }}
        ...
        .footer-logo {{ display: flex; align-items: center; justify-content: center; gap: 2px; margin-bottom: 8px; }}
        .footer-tri-y {{ width: 0; height: 0; border-left: 10px solid transparent; border-right: 10px solid transparent; border-bottom: 18px solid #d4a017; }}
        .footer-tri-g {{ width: 0; height: 0; border-left: 10px solid transparent; border-right: 10px solid transparent; border-bottom: 18px solid #15ad60; margin-left: -7px; }}
...
<body>
    <header class="header">
        <div class="header-content">
            <div class="header-left">
                <div class="logo-ci">
                    <div class="logo-tri logo-tri-yellow"></div>
                    <div class="logo-tri logo-tri-green"></div>
                </div>
                <div class="header-title">
                    <h1>HDEC DAILY NEWS</h1>
                    <span class="header-sub">AI Curated News Brief</span>
                </div>
            </div>
    ...
    <footer class="footer">
        <div class="footer-logo">
            <div class="footer-tri-y"></div>
            <div class="footer-tri-g"></div>
        </div>
